...
the standard high-retention Shorts style). All caption times are shifted by
the title-card duration since narration starts after the opening card."""
...
def build_ass(words: list[dict], out_dir: Path) -> Path:
    ...
    offset = config.TITLE_CARD_SECONDS
    lines = []
